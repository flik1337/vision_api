...
public enum ResultCode implements IErrorCode{
    ...
    ORDER_NOT_TAKED(50020,"有订单未被接，不能创建新的订单"),
    ORDER_REQUEST_NOT_END(50021,"与该接单师有未处理请求，不能多次发送"),
    ...
    //数据库操作错误
    FAIL_UPDATE_ORDER(50031,"订单表更新失败"),
    ...
    CONDITION_EMPTY(40005,"请给出条件"),
    NICKNAME_EXIST(40006,"昵称已存在"),
    NICKNAME_NOT_EXIST(40007,"昵称不存在"),
    TAKER_ID_EMPTY(40010,"接单师id不能为空"),
    WAIT_PAY_MONEY_EMPTY(40011,"请设置金额"),
    ORDER_ID_EMPTY(40020,"订单id不能为空"),
    SPBILLCREATIP_EMPTY(40020,"用户ip不能为空"),
    ...
    NOT_TAKER(40308, "该用户不是接单师"),
    TAKER_NOT_EXIST(40308, "该接单师不存在"),
    WRONG_INFO(40310, "用户名或者密码错误"),
    USER_NOT_EXIST(40311,"用户不存在"),
    USER_EXIST(40312,"用户已存在，请重新输入手机号"),
    TAKER_ERROR(40313,"您不是本订单的接单师"),
    CAN_NOT_APPLY_TAKER_AGAIN(40314,"不能重复申请成为接单师"),
    APPLICATION_SUCCESS(40315,"用户接单师审核通过"),
    ORDER_REFUNDING(60001,"订单退款中");
